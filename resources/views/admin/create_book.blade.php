            ...
            <div class="row">
                <div class="col-12 form-inner-cont">
                    @if (session()->has('add_status'))
                        ...
                        @endif
                    @endif
                    <form action="{{URL('admin/book/store')}}" method="POST" class="signin-form" enctype="multipart/form-data" id="Add-New-Book">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="form-group form-input">
                            <input type="text" name="title" id="w3lName" class="form-control" placeholder="title book" required >
                        </div>
                        <div class="form-group form-input">
                            <input type="file" name="image" id="w3lSubject" class="form-control" placeholder="book image " required >
                        </div>
                        <div class="form-group form-input">
                        ...
                        <div class="text-right">
                            <button class="btn btn-style btn-danger" id="save-button">Save</button>
                        </div>
                    </form>
                </div>
            </div>
