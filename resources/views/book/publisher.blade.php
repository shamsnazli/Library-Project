...
<div class="py-5">
    <div class="container pt-md-4 pb-md-5">
        ...
        <h3 class="category-title mb-3">{{ $book->publisher['name'] }}</h3>
        @endforeach
        <div class="row">
            @foreach ($books as $book)
                ...
                <div class="card">
                    ...
                    <div class="card-body blog-details">
                        ...
                        <div class="author align-items-center mt-3 mb-1">
                            <img src="assets/images/banner2.jpg" alt="" class="img-fluid rounded-circle" />
                            <ul class="blog-meta">
                                <li>
                                    @if (!empty($book->books_author))
                                        @foreach ($book->books_author as $books_author)
                                            @if (!empty($books_author->author))
                                                <span>Author: {{ $books_author->author['name'] }}</span>
                                            @endif
                                        @endforeach
                                        @endif
                                </li>
